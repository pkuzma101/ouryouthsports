...
<?php if ( get_theme_mod('hero_heading')) { ?>
	                <h1><?php esc_html_e( get_theme_mod( 'hero_heading' ));?></h1>
			<?php }else { ?>
...
<?php if ( get_theme_mod('hero_secondary')) { ?>
			<h2><?php esc_html_e( get_theme_mod( 'hero_secondary' )); ?></h2>
			<?php }else { ?>
...
<?php if ( get_theme_mod('hero_button_text') || get_theme_mod('hero_button_url') ) { ?>
			<div class="button"><p><a href="<?php esc_html_e(get_theme_mod('hero_button_url'), 'mobile-friendly'); ?>"><?php esc_html_e(get_theme_mod('hero_button_text'), 'mobile-friendly'); ?></a></p></div>
			<?php }else { ?>
...
<?php if ( get_theme_mod('hero_image') || get_theme_mod('hero_image_alt')) { ?>
			<div class="achimps"><img class="cc-credit-logo" src="<?php esc_html_e(get_theme_mod('hero_image'), 'mobile-friendly'); ?>" alt="<?php esc_html_e(get_theme_mod('hero_image_alt'), 'mobile-friendly'); ?>"/></div>
			<?php } else { ?>
	...
	<section class="cta">
		<div class="cta-content">
			<div class="featured-image">
				<img src="<?php esc_html_e(get_theme_mod('cta_image'), 'mobile-friendly'); ?>" />
			</div>
			<div class="content">
				<h2><?php esc_html_e(get_theme_mod('cta_text')); ?></h2>
				<div class="first-button">
					<p><a href="<?php esc_html_e(get_theme_mod('cta_button_url'), 'mobile-friendly'); ?>"><?php esc_html_e(get_theme_mod('cta_button_text')); ?></a></p>
				</div>
				<div class="second-button">
					<p><a href="<?php esc_html_e(get_theme_mod('cta_second_button_url'), 'mobile-friendly'); ?>"><?php esc_html_e(get_theme_mod('cta_second_button_text')); ?></a></p>
				</div>
			</div>
		</div>
	</section>
...
<section class="teaser">
	<div class="teaser-content">
		...
		<h3><?php esc_html_e(get_theme_mod('teaser_text')); ?></h3>
		<?php } else { ?>
